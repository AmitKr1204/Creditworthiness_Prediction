...
# st.markdown("<p class='sub-title'>Enter applicant information to analyze and predict their creditworthiness.</p>", unsafe_allow_html=True)
...
#                 <h3 style='color:#166534;'>✅ Credit Risk: <b>GOOD</b></h3>
#                 <p>This applicant is financially reliable and likely to repay credit on time.</p>
#             </div>
#             """, unsafe_allow_html=True)
#         else:
#             st.markdown("""
#             <div class='card' style='border-left: 6px solid #dc2626;'>
#                 <h3 style='color:#991b1b;'>❌ Credit Risk: <b>BAD</b></h3>
#                 <p>This applicant shows signs of higher credit risk and may default on payments.</p>
#             </div>
#             """, unsafe_allow_html=True)
